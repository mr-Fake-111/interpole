...
fun graphByNodesSplineCubic(group: Group, properties: Array<DoubleArray>, widgth:Double, height:Double) {
    val polys = Interpolator.interpolationSplineCubic(properties)

    for (i in 1 until properties.size) { //выводим график для Кубического сплайна
